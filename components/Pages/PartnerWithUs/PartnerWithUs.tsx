                ...
                <div className="w-full z-10 relative items-center flex flex-col gap-7 max-md:gap-5 py-40 max-md:py-10 px-20 max-md:px-10 max-sm:px-4">
                    ...
                    >
                        <Link
                            ...
                            href="https://forms.gle/xNVwvEABNQrgoZwJ6" className="z-10 bg-gradient-to-r from-rich-violet to-[#704bd2] px-6 py-3 rounded-xl text-white font-medium hover:from-rich-violet/60 hover:to-[#704bd2]/60 transition ease-in-out duration-200 max-sm:px-3 max-sm:py-2 max-sm:text-sm max-sm:rounded-lg">
                            Become a Partner
                        </Link>
